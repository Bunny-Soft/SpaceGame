...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
		...
		//glview = GLViewImpl::createWithRect("SpaceShooter", cocos2d::Rect(0, 0, 1280, 720));
		glview = GLViewImpl::createWithFullScreen("SpaceShooter");
#else
